<template>
  <div>
    ...
    <div class="mb-3" v-if="user.user_contact && user.user_contact.length > 0">
    ...
    <div class="mb-3" v-if="user.user_city && user.user_city.length > 0">
    ...
    <div class="mb-3" v-if="user.user_language && user.user_language.length > 0">
    ...
    <div class="mb-3" v-if="user.user_service && user.user_service.length > 0">
